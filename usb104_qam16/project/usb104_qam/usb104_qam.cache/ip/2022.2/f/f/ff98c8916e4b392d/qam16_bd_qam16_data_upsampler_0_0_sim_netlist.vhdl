...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_qam16_data_upsampler is
  ...
  signal \m_axis_imag_tdata[11]_i_1_n_0\ : STD_LOGIC;
  signal \m_axis_imag_tdata[15]_i_1_n_0\ : STD_LOGIC;
  signal \m_axis_imag_tdata[6]_i_1_n_0\ : STD_LOGIC;
  signal \m_axis_imag_tdata[9]_i_1_n_0\ : STD_LOGIC;
  signal \m_axis_real_tdata[11]_i_1_n_0\ : STD_LOGIC;
  ...
  signal \m_axis_real_tdata[6]_i_1_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \m_axis_imag_tdata[11]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \m_axis_imag_tdata[15]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \m_axis_imag_tdata[6]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \m_axis_imag_tdata[9]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \m_axis_real_tdata[11]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \m_axis_real_tdata[15]_i_2\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \m_axis_real_tdata[3]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \m_axis_real_tdata[6]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \m_axis_real_tdata[9]_i_1\ : label is "soft_lutpair6";
...
\m_axis_imag_tdata[11]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0880"
    )
        port map (
...
\m_axis_imag_tdata[6]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8008"
    )
        port map (
...
\m_axis_imag_tdata[9]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"80"
    )
        port map (
...
\m_axis_imag_tdata_reg[11]\: unisim.vcomponents.FDRE
     port map (
      C => aclk,
...
\m_axis_imag_tdata_reg[6]\: unisim.vcomponents.FDRE
     port map (
      C => aclk,
      CE => upsampling_counter,
...
\m_axis_real_tdata[11]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0880"
    )
        port map (
...
\m_axis_real_tdata[3]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\m_axis_real_tdata[6]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8008"
    )
        port map (
...
\m_axis_real_tdata[9]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"80"
    )
        port map (
...
\m_axis_real_tdata_reg[11]\: unisim.vcomponents.FDRE
     port map (
      C => aclk,
      CE => upsampling_counter,
...
\m_axis_real_tdata_reg[6]\: unisim.vcomponents.FDRE
     port map (
      C => aclk,
      CE => upsampling_counter,
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  signal \^m_axis_real_tdata\ : STD_LOGIC_VECTOR ( 14 downto 4 );
...
begin
  ...
  m_axis_imag_tdata(13) <= \^m_axis_imag_tdata\(14);
  m_axis_imag_tdata(12) <= \^m_axis_imag_tdata\(14);
  m_axis_imag_tdata(11) <= \^m_axis_imag_tdata\(4);
  m_axis_imag_tdata(10) <= \^m_axis_imag_tdata\(14);
  m_axis_imag_tdata(9) <= \^m_axis_imag_tdata\(8);
  m_axis_imag_tdata(8) <= \^m_axis_imag_tdata\(8);
  m_axis_imag_tdata(7) <= \^m_axis_imag_tdata\(8);
  m_axis_imag_tdata(6) <= \^m_axis_imag_tdata\(6);
  m_axis_imag_tdata(5) <= \^m_axis_imag_tdata\(8);
  m_axis_imag_tdata(4 downto 3) <= \^m_axis_imag_tdata\(4 downto 3);
  ...
  m_axis_real_tdata(13) <= \^m_axis_real_tdata\(14);
  m_axis_real_tdata(12) <= \^m_axis_real_tdata\(14);
  m_axis_real_tdata(11) <= \^m_axis_real_tdata\(4);
  m_axis_real_tdata(10) <= \^m_axis_real_tdata\(14);
  m_axis_real_tdata(9) <= \^m_axis_real_tdata\(8);
  m_axis_real_tdata(8) <= \^m_axis_real_tdata\(8);
  m_axis_real_tdata(7) <= \^m_axis_real_tdata\(8);
  m_axis_real_tdata(6) <= \^m_axis_real_tdata\(6);
  m_axis_real_tdata(5) <= \^m_axis_real_tdata\(8);
  m_axis_real_tdata(4) <= \^m_axis_real_tdata\(4);
...
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_qam16_data_upsampler
     port map (
      ...
      m_axis_imag_tdata(2) => \^m_axis_imag_tdata\(4),
      m_axis_imag_tdata(1) => \^m_axis_imag_tdata\(8),
      m_axis_imag_tdata(0) => \^m_axis_imag_tdata\(6),
      m_axis_imag_tready => m_axis_imag_tready,
      m_axis_imag_tvalid => \^m_axis_imag_tvalid\,
      m_axis_real_tdata(4) => \^m_axis_real_tdata\(14),
      m_axis_real_tdata(3) => \^m_axis_real_tdata\(4),
      m_axis_real_tdata(2) => \^m_axis_real_tdata\(8),
      m_axis_real_tdata(1) => \^m_axis_real_tdata\(6),
