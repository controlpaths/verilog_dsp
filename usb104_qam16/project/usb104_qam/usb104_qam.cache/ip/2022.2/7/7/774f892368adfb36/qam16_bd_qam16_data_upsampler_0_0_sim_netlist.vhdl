...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_qam16_data_upsampler is
  ...
  signal \FSM_sequential_qam16_upsampler_state[1]_i_2_n_0\ : STD_LOGIC;
  signal \m_axis_imag_tdata[13]_i_1_n_0\ : STD_LOGIC;
  signal \m_axis_imag_tdata[14]_i_1_n_0\ : STD_LOGIC;
  signal \m_axis_imag_tdata[15]_i_1_n_0\ : STD_LOGIC;
  signal \m_axis_imag_tdata[9]_i_1_n_0\ : STD_LOGIC;
  signal \m_axis_real_tdata[13]_i_1_n_0\ : STD_LOGIC;
  signal \m_axis_real_tdata[14]_i_1_n_0\ : STD_LOGIC;
  ...
  signal \m_axis_real_tdata[4]_i_1_n_0\ : STD_LOGIC;
  signal \m_axis_real_tdata[9]_i_1_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \FSM_sequential_qam16_upsampler_state[1]_i_1\ : label is "soft_lutpair1";
  attribute FSM_ENCODED_STATES : string;
  attribute FSM_ENCODED_STATES of \FSM_sequential_qam16_upsampler_state_reg[0]_inv\ : label is "iSTATE:11,iSTATE0:10,iSTATE1:00,iSTATE2:01";
  attribute inverted : string;
  attribute inverted of \FSM_sequential_qam16_upsampler_state_reg[0]_inv\ : label is "yes";
  attribute FSM_ENCODED_STATES of \FSM_sequential_qam16_upsampler_state_reg[1]\ : label is "iSTATE:11,iSTATE0:10,iSTATE1:00,iSTATE2:01";
  attribute SOFT_HLUTNM of \m_axis_imag_tdata[13]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \m_axis_imag_tdata[14]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \m_axis_imag_tdata[15]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \m_axis_imag_tdata[9]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \m_axis_real_tdata[13]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \m_axis_real_tdata[14]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \m_axis_real_tdata[15]_i_2\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \m_axis_real_tdata[4]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \m_axis_real_tdata[9]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of m_axis_real_tvalid_i_1 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of s_axis_tready_INST_0 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \upsampling_counter[0]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \upsampling_counter[1]_i_1\ : label is "soft_lutpair5";
...
begin
\FSM_sequential_qam16_upsampler_state[0]_inv_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"1C1F1C1CFFFFFFFF"
    )
        port map (
      I0 => s_axis_tvalid,
...
\FSM_sequential_qam16_upsampler_state[1]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0400"
    )
        port map (
...
\m_axis_imag_tdata[14]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0880"
    )
        port map (
      ...
      I2 => s_axis_tdata(3),
      I3 => s_axis_tdata(2),
      O => \m_axis_imag_tdata[14]_i_1_n_0\
    );
\m_axis_imag_tdata[15]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"08"
    )
        port map (
...
\m_axis_imag_tdata[9]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8008"
    )
        port map (
...
\m_axis_imag_tdata_reg[14]\: unisim.vcomponents.FDRE
     port map (
      C => aclk,
      CE => upsampling_counter,
      D => \m_axis_imag_tdata[14]_i_1_n_0\,
...
\m_axis_imag_tdata_reg[9]\: unisim.vcomponents.FDRE
     port map (
      C => aclk,
      CE => upsampling_counter,
...
\m_axis_real_tdata[14]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0880"
    )
        port map (
      ...
      I2 => s_axis_tdata(1),
      I3 => s_axis_tdata(0),
      O => \m_axis_real_tdata[14]_i_1_n_0\
    );
...
\m_axis_real_tdata[15]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"08"
    )
        port map (
...
\m_axis_real_tdata[15]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000001"
    )
        port map (
...
\m_axis_real_tdata[4]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
      I0 => qam16_upsampler_state(1),
      I1 => \m_axis_real_tdata[15]_i_3_n_0\,
      O => \m_axis_real_tdata[4]_i_1_n_0\
    );
\m_axis_real_tdata[9]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8008"
    )
        port map (
...
\m_axis_real_tdata_reg[14]\: unisim.vcomponents.FDRE
     port map (
      C => aclk,
      CE => upsampling_counter,
      D => \m_axis_real_tdata[14]_i_1_n_0\,
...
\m_axis_real_tdata_reg[4]\: unisim.vcomponents.FDRE
     port map (
      C => aclk,
      CE => upsampling_counter,
      D => \m_axis_real_tdata[4]_i_1_n_0\,
      Q => m_axis_real_tdata(0),
      R => \m_axis_real_tdata[15]_i_1_n_0\
    );
\m_axis_real_tdata_reg[9]\: unisim.vcomponents.FDRE
     port map (
      C => aclk,
      CE => upsampling_counter,
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  signal \^m_axis_imag_tdata\ : STD_LOGIC_VECTOR ( 12 downto 4 );
  signal \^m_axis_imag_tvalid\ : STD_LOGIC;
  signal \^m_axis_real_tdata\ : STD_LOGIC_VECTOR ( 12 downto 9 );
...
begin
  m_axis_imag_tdata(15) <= \^m_axis_imag_tdata\(11);
  m_axis_imag_tdata(14) <= \^m_axis_imag_tdata\(12);
  m_axis_imag_tdata(13) <= \^m_axis_imag_tdata\(10);
  m_axis_imag_tdata(12 downto 9) <= \^m_axis_imag_tdata\(12 downto 9);
  m_axis_imag_tdata(8) <= \^m_axis_imag_tdata\(10);
  m_axis_imag_tdata(7) <= \^m_axis_imag_tdata\(11);
  m_axis_imag_tdata(6) <= \^m_axis_imag_tdata\(11);
  m_axis_imag_tdata(5) <= \^m_axis_imag_tdata\(12);
  m_axis_imag_tdata(4) <= \^m_axis_imag_tdata\(4);
  m_axis_imag_tdata(3) <= \<const0>\;
  m_axis_imag_tdata(2) <= \<const0>\;
  m_axis_imag_tdata(1) <= \<const0>\;
  m_axis_imag_tdata(0) <= \<const0>\;
  m_axis_imag_tvalid <= \^m_axis_imag_tvalid\;
  m_axis_real_tdata(15) <= \^m_axis_real_tdata\(11);
  m_axis_real_tdata(14) <= \^m_axis_real_tdata\(12);
  m_axis_real_tdata(13) <= \^m_axis_real_tdata\(10);
  m_axis_real_tdata(12 downto 9) <= \^m_axis_real_tdata\(12 downto 9);
  m_axis_real_tdata(8) <= \^m_axis_real_tdata\(10);
  m_axis_real_tdata(7) <= \^m_axis_real_tdata\(11);
  m_axis_real_tdata(6) <= \^m_axis_real_tdata\(11);
  m_axis_real_tdata(5) <= \^m_axis_real_tdata\(12);
  m_axis_real_tdata(4) <= \^m_axis_imag_tdata\(4);
  m_axis_real_tdata(3) <= \<const0>\;
...
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_qam16_data_upsampler
     port map (
      aclk => aclk,
      m_axis_imag_tdata(3) => \^m_axis_imag_tdata\(11),
      m_axis_imag_tdata(2) => \^m_axis_imag_tdata\(12),
      m_axis_imag_tdata(1 downto 0) => \^m_axis_imag_tdata\(10 downto 9),
      m_axis_imag_tready => m_axis_imag_tready,
      m_axis_imag_tvalid => \^m_axis_imag_tvalid\,
      m_axis_real_tdata(4) => \^m_axis_real_tdata\(11),
      m_axis_real_tdata(3) => \^m_axis_real_tdata\(12),
      m_axis_real_tdata(2 downto 1) => \^m_axis_real_tdata\(10 downto 9),
      m_axis_real_tdata(0) => \^m_axis_imag_tdata\(4),
