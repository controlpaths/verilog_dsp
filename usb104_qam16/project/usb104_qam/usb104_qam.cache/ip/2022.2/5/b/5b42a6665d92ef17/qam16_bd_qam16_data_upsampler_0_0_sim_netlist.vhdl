...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_qam16_data_upsampler is
  ...
  attribute SOFT_HLUTNM of \m_axis_imag_tdata[13]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \m_axis_imag_tdata[15]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \m_axis_imag_tdata[8]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \m_axis_real_tdata[12]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \m_axis_real_tdata[13]_i_1\ : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of \m_axis_real_tdata[8]_i_1\ : label is "soft_lutpair2";
...
\m_axis_imag_tdata[12]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"80"
    )
        port map (
...
\m_axis_imag_tdata[13]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0880"
    )
        port map (
...
\m_axis_imag_tdata[8]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8008"
    )
        port map (
...
\m_axis_real_tdata[12]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"80"
    )
        port map (
...
\m_axis_real_tdata[13]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0880"
    )
        port map (
...
\m_axis_real_tdata[8]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8008"
    )
        port map (
