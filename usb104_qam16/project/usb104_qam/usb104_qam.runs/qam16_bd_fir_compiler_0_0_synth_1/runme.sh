...
HD_PWD='/home/pablo/git/verilog_dsp/usb104_qam16/project/usb104_qam/usb104_qam.runs/qam16_bd_fir_compiler_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log qam16_bd_fir_compiler_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source qam16_bd_fir_compiler_0_0.tcl
