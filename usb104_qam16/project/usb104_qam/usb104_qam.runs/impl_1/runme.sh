...
HD_PWD='/home/pablo/git/verilog_dsp/usb104_qam16/project/usb104_qam/usb104_qam.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log qam16_bd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source qam16_bd_wrapper.tcl -notrace
